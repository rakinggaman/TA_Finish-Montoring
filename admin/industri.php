        ...
        <div class="wrapper">
            ...
            <div class="content">
                <div class="content-header d-flex align-items-center justify-content-between">
                    <h2 class="content-title">industri</h2>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Tambah Data Industri</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <form class="form-horizontal" method="post" action="konfirmasi_tambah_industri.php">

                                    <div class="mb-3">
                                        <label for="recipient-name" class="col-form-label">Industri :</label>
                                        <input type="text" class="form-control" id="part_name" name="industri" placeholder="Isi Industri" />
                        ...
                        <div class="col mt-5">
                            ...
                            <table class="table bg-white rounded shadow-sm  table-hover">
                                ...
                                <tbody>
                                    ...
                                    $sql_h .= "order by `industri` DESC limit $posisi, $batas";
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form class="form-horizontal" method="post" action="konfirmasi_edit_industri.php">
                                                                    <input type="hidden" name="kode" value="<?= $kode_industri ?>">
                                                                    <div class="mb-3">
                            ...
                            <div class="card-footer clearfix">
                                <?php
                                //Menghitung jumlah
                                $sql_jum = "SELECT `kode_industri`,`industri` FROM `industri` order by `kode_industri` ";
                        	...
                        	href='industri.php?katakunci=$katakunci_industri&halaman=1'>
                        	First</a></li>";
                                                echo "<li class='page-item'><a class='page-link'
                        	href='industri.php?katakunci=$katakunci_industri&halaman=$sebelum'> 18.		«</a></li>";
                                            }
                                            for ($i = 1; $i <= $jum_halaman; $i++) {
                                                if ($i != $halaman) {
                                                    echo "<li class='page-item'><a class='page-link'
                                	href='industri.php?katakunci=$katakunci_industri&halaman=$i'>
                                	$i</a></li>";
                                                } else {
                                	...
                                	<a class='page-link'>$i</a></li>";
                                            ...
                                            if ($halaman != $jum_halaman) {
                                                echo "<li class='page-item'><a class='page-link'
                                	href='industri.php?katakunci=$katakunci_industri&halaman=$setelah'>
                                		»</a></li>";
                                                echo "<li class='page-item'><a class='page-link'
                                		href='industri.php?katakunci=$katakunci_industri&=$jum_halaman'>
                                		Last</a></li>";
                                            }
                                        } else {
                                            if ($halaman != 1) {
                                                echo "<li class='page-item'><a class='page-link'
                                	href='industri.php?halaman=1'>First</a></li>";
                                                echo "<li class='page-item'><a class='page-link'
                                	href='industri.php?halaman=$sebelum'>«</a></li>";
                                            }
                                            for ($i = 1; $i <= $jum_halaman; $i++) {
                                                if ($i != $halaman) {
                                                    echo "<li class='page-item'><a class='page-link'
                                	href='industri.php?halaman=$i'>$i</a></li>";
                                                } else {
                                	...
                                	link'>$i</a></li>";
                                            ...
                                            if ($halaman != $jum_halaman) {
                                                echo "<li class='page-item'><a class='page-link'
                                	href='industri.php?halaman=$setelah'>»</a></li>";
                                                echo "<li class='page-item'><a class='page-link'
                                	href='industri.php?halaman=$jum_halaman'>Last</a></li>";
                                            }
                                        }
                                    } ?>
                                </ul>
