                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td data-label="Aksi">
                                                <a class="editbtn second-text btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModaledit<?= $kode_produk ?>"> <i class="fas fa-edit me-2"></i>Edit</a>
                                                ...
                                                <a href="javascript:if(confirm('Anda yakin ingin menghapus data?
                                                        <?php echo $produk; ?>?'))	window.location.href = 'produk.php?aksi=hapus&data=<?php echo
                                                                                                                                            $kode_produk; ?>'" class="deletebtn           danger-text btn-sm"><i class="fas fa-trash me-2"></i>Delete</a>
